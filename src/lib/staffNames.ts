 ...
 *
 * Those columns arrive with supabase-migrations/20260913_staff_name_parts.sql.
 * A deployment that has not run the migration yet still works:
 * `hasNameColumns()` reports false and callers fall back to the combined `name`.
 */
